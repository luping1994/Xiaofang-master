...
public class DbHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String sqls = " create table  attr_main ( NID INTEGER primary key autoincrement,"  //用户名ID 唯一标示通道 ，自增长
				+ "Id TEXT,"   //id
				+ "Name TEXT)";     //地址
		db.execSQL(sqls);


		String sqls2 = " create table  attr_sub ( NID INTEGER primary key autoincrement,"  //用户名ID 唯一标示通道 ，自增长
				+ "Id TEXT,"   //id
				+ "Name TEXT,"
				+ "ParentId TEXT)";     //地址
		db.execSQL(sqls2);
