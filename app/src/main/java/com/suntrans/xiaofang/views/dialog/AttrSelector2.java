...
public class AttrSelector2 implements View.OnClickListener {
    ...
    private GeneralProvider defaultProvider;
    ...
    public AttrSelector2(Context context) {
...
//
        defaultProvider = new GeneralProvider(context);
