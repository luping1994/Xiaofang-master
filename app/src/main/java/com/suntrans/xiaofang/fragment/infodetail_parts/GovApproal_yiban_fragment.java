...
public class GovApproal_yiban_fragment extends BasedFragment {
    ...
    class MyAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == 0) {
                ...
                return new GovApproal_yiban_fragment.MyAdapter.ViewHolder1(v);
            } else if (viewType == 1) {
                View view = LayoutInflater.from(getActivity()).inflate(R.layout.item_xingzhengxuke2, parent, false);
                return new GovApproal_yiban_fragment.MyAdapter.ViewHolder2(view);
            } else if (viewType == 2) {
                View view = LayoutInflater.from(getActivity()).inflate(R.layout.item_search_activity2, parent, false);
                return new GovApproal_yiban_fragment.MyAdapter.ViewHolder3(view);
            } else {
                return null;
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof GovApproal_yiban_fragment.MyAdapter.ViewHolder1) {
                ((GovApproal_yiban_fragment.MyAdapter.ViewHolder1) holder).setData(position);
            } else if (holder instanceof GovApproal_yiban_fragment.MyAdapter.ViewHolder2) {
                ((GovApproal_yiban_fragment.MyAdapter.ViewHolder2) holder).setData(position);
            } else if (holder instanceof GovApproal_yiban_fragment.MyAdapter.ViewHolder3) {
                ((GovApproal_yiban_fragment.MyAdapter.ViewHolder3) holder).setData(position);
            }
        }
                    ...
                    public void call(CompanyLicenseResult result) {
                        if (result != null) {
                            if (result.status.equals("1")) {
                                GovApproal_yiban_fragment.this.infos = result.result;
                                refreshView(GovApproal_yiban_fragment.this.infos);
                            }
    ...
    private void refreshView(List<CompanyLicenseInfo> infos) {
        ...
        myAdapter = null;
        myAdapter = new GovApproal_yiban_fragment.MyAdapter();
