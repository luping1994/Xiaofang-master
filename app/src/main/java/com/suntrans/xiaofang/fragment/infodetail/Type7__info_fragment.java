 ...
 * 政府小型工作站详情信息fragment(已经和乡村合并)
 */

@Deprecated
public class Type7__info_fragment extends BasedFragment implements View.OnClickListener {
    ...
    private void refreshView(FireStationDetailInfo info) {
        ...
        if (member!=null&&!member.equals("")){
            try {
                ...
                datas.get(4).put(1, info.membernum == null ? "--" : xianyiganbu + "人");
                datas.get(5).put(1, info.membernum == null ? "--" : gonganganbu+"人");
        ...
        datas.get(7).put(1, info.cardisp == null ? "--" : cardis);
        datas.get(8).put(1, info.waterweight == null ? "--" : info.waterweight);
        datas.get(9).put(1, info.soapweight == null ? "--" : info.soapweight);
        datas.get(10).put(1, info.brigade_path == null ? "--" : info.brigade_path);
        datas.get(11).put(1, info.street==null?"--":info.admindivi_path);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.xiugai:
                ...
                intent.setClass(getActivity(), EditFireAdminStationInfo_activity.class);
